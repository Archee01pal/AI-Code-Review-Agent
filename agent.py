"""
Code Review Agent using LangChain and Google Gemini.
...
# Suppress standard Python runtime warnings
...
def review_code(code: str, language: str = "python") -> str:
    ...
    # Safely unpack text structured list from newer LangChain response objects
    if isinstance(response.content, list):
        text_parts = [part.get("text", "") for part in response.content if isinstance(part, dict)]
        return "\n".join(text_parts)
