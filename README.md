...
An automated static code analysis agent built with **LangChain** and **Google Gemini** that reviews source code for runtime bugs, security vulnerabilities, performance bottlenecks, and PEP 8 style violations.
